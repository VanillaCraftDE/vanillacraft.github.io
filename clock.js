window.addEventListener("load", function () {
        var theRealease = new Date("July 30, 2021 18:00:00").getTime();
        ...
        var interval = setInterval(function () {
                ...
                if (d < 0) {
                        ...
                        document.getElementById("title").innerHTML = 'VanillaCraft Staffel3 ist offiziell gestartet!';
                        document.querySelector(".finished").innerHTML = 'Die DynMap sollte gleich verfügbar sein.';
                }
        }, 1000);
});
